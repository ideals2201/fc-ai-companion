...
export type StageOneRewardButtonPatch = {
  ...
  reason:
    ...
    | "stage-one-w1465-grounded-stall-right-up-fire"
    | "stage-one-w1730-upper-air-right-fire-carry"
    | "stage-one-w241-air-close-type5-neutral-fire"
    ...
    | "stage-one-w1765-grounded-rear-micro-duck"
    | "stage-one-w1769-reentry-right-extend"
    | "stage-one-w1686-left-edge-close-body-right-guard"
    | "stage-one-w1686-left-edge-overhead-duck-guard"
    | "stage-one-w1686-left-edge-duck-hold-guard"
    | "stage-one-w1721-airborne-upper-preclear-right-fire"
    | "stage-one-close-body-threat"
    | "stage-one-red-turret-low-threat"
    | "stage-one-boss-approach-close-body"
    | "stage-one-boss-approach-entry-jump"
    | "stage-one-boss-approach-ground-run"
    | "stage-one-boss-approach-high-air-carry"
    | "stage-one-boss-approach-high-edge-jump"
    | "stage-one-boss-approach-held-jump"
    | "stage-one-boss-approach-late-edge-jump"
    | "stage-one-boss-approach-mid-platform-edge-jump"
    | "stage-one-boss-approach-mid-platform-capture"
    | "stage-one-boss-approach-platform-jump"
    | "stage-one-boss-entry-duck-fire"
    | "stage-one-boss-approach-jump-edge"
    | "stage-one-bridge-low-fixed-crowd"
    | "stage-one-danger-low-lane-fall"
    | "stage-one-descent-lower-body-right-carry"
    ...
    | "stage-one-overhead-body-guard-preclear"
    | "stage-one-pit-entry-delayed-jump"
    | "stage-one-pit-entry-ground-carry"
    | "stage-one-pit-entry-right-carry"
    | "stage-one-pit-exit-platform-carry"
    | "stage-one-pit-exit-platform-jump"
    | "stage-one-same-lane-contact-right-carry"
    | "stage-one-same-lane-preclear-pulse"
    | "stage-one-upper-body-jump-edge"
    | "stage-one-weapon-gate-air-preclear"
    | "stage-one-weapon-gate-air-carry"
    | "stage-one-weapon-gate-platform-jump"
    | "stage-one-weapon-gate-jump-suppress"
