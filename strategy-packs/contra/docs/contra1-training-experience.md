...
- W1688 preclear batch `jp-s1-w1688-preclear-phase-shaping-rejected-20260612` confirms the earlier repair point is useful: right-fire/right-up/pulsed-fire variants move the W300 weapon16 branch to local no-death W1942 with `weapon = 16`.
- This is still not a clear candidate. The best advancing variants die around W1943; W2726 post-loss progress is invalid because the weapon resets to 0. The saved continuation state is `jp-stage1-w1942-weapon16-from-w1688-preclear-20260612.json`.
- W1942 low-body geometry batch `jp-s1-w1942-lowbody-geometry-rejected-20260612` proves that saved state is also too late. All 12 immediate duck, jump, left/right, and fire-angle rescue variants lost active at frame 9473 with no no-death progress beyond W1942.
- Do not repeat W1499 breakout-only variants, W1785 contact-frame swaps, W1688 single-window fire-angle sweeps, or W1942 immediate rescues; the next useful segment is W1880-W1940 phase shaping before the low same-lane body overlap forms.
