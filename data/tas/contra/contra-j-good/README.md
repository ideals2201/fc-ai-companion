...
- Any extracted fragment must record its source file, ROMProfile, frame or WorldX window, validation trace, and safety overrides before promotion to a strategy pack.
