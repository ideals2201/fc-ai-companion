...
The UI should show each side's selected pack name and strategy type. A global pack name is useful for the current simple mode, but dual-AI and human-AI modes need side-owned display later.
